  ...
  return (
    <div className="min-h-screen bg-background text-foreground antialiased">
      ...
      <section className="container pb-20">
        <SectionTitle eyebrow="Спустя годы" title="Большая радость" />
        <div className="mx-auto max-w-2xl space-y-6 text-lg leading-relaxed text-foreground/90">
          <p>
            Сегодня я хочу поделиться своей большой радостью. Мой сын успешно
            окончил школу и поступил в один из престижных университетов
            Канады. И, конечно, как мама я безмерно счастлива и горжусь им.
          </p>
          <p>
            Но сегодня мне хочется посмотреть на эту историю не только
            глазами мамы, но и глазами психолога.
          </p>
          <p>
            Я абсолютно убеждена, что успех человека складывается не только
            из хорошего образования, способностей или удачного стечения
            обстоятельств. Всё начинается гораздо раньше — с того, какие
            убеждения о себе и о мире живут внутри нас.
          </p>
          <p>
            Можно быть очень талантливым человеком и всю жизнь сомневаться в
            себе. Можно иметь прекрасное образование, но бояться
            проявляться, брать на себя ответственность и реализовывать свой
            потенциал. Можно обладать огромными возможностями, но внутренне
            быть уверенным, что ты недостаточно хорош или что большие
            достижения не для тебя.
          </p>
          <p>
            За годы своей практики я всё больше убеждаюсь, что здоровая
            самооценка, правильные амбиции, умение ставить перед собой
            большие цели, способность действовать несмотря на страх и
            разрешение себе быть успешным — это не менее важно, чем знания и
            навыки.
          </p>
          <p>
            Именно поэтому, будучи психологом, я всегда уделяла большое
            внимание не только воспитанию сына, но и работе с его
            внутренними сценариями и ограничивающими убеждениями. Мы вместе
            формировали здоровое отношение к ошибкам, к своим желаниям, к
            достижениям, к деньгам, к самореализации и к собственным
            возможностям.
          </p>
          <p>
            Для меня было важно, чтобы он вырос не просто успешным
            человеком, а человеком, который знает себе цену, умеет принимать
            решения, не боится пробовать новое и понимает, что имеет полное
            право реализовывать свой потенциал.
          </p>
          <p>
            Я часто говорю своим клиентам, что наши результаты во взрослой
            жизни начинаются не тогда, когда мы покупаем очередное обучение
            или ставим новую цель. Они начинаются гораздо раньше — с того,
            что мы думаем о себе и что считаем для себя возможным.
          </p>
          <p>
            Сегодня, глядя на своего сына, я понимаю, насколько важна эта
            внутренняя работа. Потому что настоящий успех — это не только
            диплом престижного университета или карьерные достижения. Это
            способность быть счастливым человеком, жить свою жизнь, смело
            идти за своими целями и не предавать себя на этом пути.
          </p>

          <div className="rounded-3xl gold-gradient p-8">
            <p className="text-lg font-medium leading-relaxed text-emerald-deep">
              И, пожалуй, именно этого я желаю каждому человеку — не просто
              добиться внешнего успеха, а позволить себе быть реализованным,
              уверенным в себе и счастливым.
            </p>
          </div>

          <p>
            Ведь самые большие ограничения в нашей жизни чаще всего находятся
            не снаружи, а внутри нас. И хорошая новость заключается в том,
            что с ними можно и нужно работать.
          </p>
          <p>
            Если вы чувствуете, что способны на гораздо большее, но снова и
            снова откладываете свою реализацию, боитесь проявляться,
            сомневаетесь в себе или будто живёте не на полную силу своих
            возможностей, приглашаю вас на бесплатную диагностику.
          </p>
          <p>
            На ней мы разберём, какие внутренние сценарии и убеждения мешают
            вам двигаться вперёд, и определим, что именно поможет вам выйти
            на новый уровень в жизни, отношениях, самореализации и доходе.
          </p>
          <p>
            Возможно, именно один разговор станет для вас первым шагом к той
            жизни, которую вы давно заслуживаете.
          </p>
        </div>
        <div className="mt-10 flex flex-wrap justify-center gap-4">
          <CTA tg>Бесплатная диагностика</CTA>
        </div>
      </section>
