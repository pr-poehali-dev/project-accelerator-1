...
const Index = () => {
  const tariffs = [
    {
      ...
      features: [
        'Проработка одного ключевого сценария',
    ...
    },
    {
      ...
      features: [
        'Проработка до двух ключевых сценариев',
  ...
  const reviews = [
    ...
    {
      name: 'Алла',
      text: 'Гульмира, привет! Благодарю тебя, дорогая. Моё состояние начало меняться. Я становлюсь увереннее и лучше слышу себя. Такое чувство, что жила только страхом. А сейчас он уходит. Я стала верить в себя ❣️❣️❣️',
      photo: 'https://cdn.poehali.dev/projects/e66c6c7d-b465-4059-a952-5c768d48be08/files/a5adb0a6-ec9d-42af-aed9-60bfc0c026d9.jpg',
    },
  ];
